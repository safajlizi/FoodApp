...
public class TinyDB {
    ...
    public ArrayList<FoodDomaine> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodDomaine> playerList =  new ArrayList<FoodDomaine>();

        for(String jObjString : objStrings){
            FoodDomaine player  = gson.fromJson(jObjString,  FoodDomaine.class);
    ...
    public void putListObject(String key, ArrayList<FoodDomaine> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodDomaine player: playerList){
